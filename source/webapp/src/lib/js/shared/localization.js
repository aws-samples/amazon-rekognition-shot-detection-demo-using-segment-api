  ...
  static get Languages() {
    return {
      'en-US': {
        Messages: {
          /* signin flow */
          Title: 'Shot Detection Demo <span style="font-size:0.85rem">by AWS Specialist SA, AI/ML Team</span>',
          ...
          ProjectTab: 'Project',
          DropzoneDesc: '<p>Drag and drop\' video to the \'drop area\' to start analysis. Video file extensions can be .mpg, .mpeg, .ts, .mp4, .m4v, .mov, .avi or .mxf. You can drop multiple videos or folders up to 20 files. (Note: Folder is supported in Chrome, Firefox, and Edge browsers.)</p>',
          ...
          ShotDetectionDesc: '<a href="" target="_blank">Amazon Rekognition Video Segment APIs</a> support \'Shot segments\' and \'Techincal Cues\' detections. Click on the buttons to see the detection results in action.',
          EditDecisionListDesc: 'This demo converts the shot segments result into Edit Decision List (EDL) file. You can download and import the timeline into popular editing software.',
