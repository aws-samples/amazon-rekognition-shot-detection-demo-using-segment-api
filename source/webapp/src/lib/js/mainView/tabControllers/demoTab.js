...
import DropzoneSlideComponent from './demo/dropzoneSlideComponent.js';
import PreviewSlideComponent from './demo/previewSlideComponent.js';

export default class DemoTab extends mxSpinner(BaseTab) {
  constructor(defaultTab = false) {
    super(Localization.Messages.DemoTab, {
      selected: defaultTab,
    });
